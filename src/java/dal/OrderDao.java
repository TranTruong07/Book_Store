...
public class OrderDao extends DBContext {
    ...
    public boolean addOrder(Order o) {
        try {
            ...
            ps.setString(1, o.getCustomer().getUserName());
            ps.setDate(2, o.getOderDate());
            ps.setDouble(3, o.getTotal_money());
            ps.setInt(4, o.getStatusId());
...
//    }
    public boolean addOrderDetails(OrderDetails od) {
        try {
            String sql = "insert into OrderDetails(oid, pid, quantity, total_price)\n"
                    + "values(?, ?, ?, ?)";
            PreparedStatement ps = connection.prepareStatement(sql);
