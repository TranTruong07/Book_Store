 ...
 */
@MultipartConfig
public class AddBookAdmin_Servlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        request.getRequestDispatcher("Views/addManagement.jsp").forward(request, response);
    } 
...
//            BookService bookService = BookService.getInstance();
//            if (bookService.addBook(categoryid, b)) {
